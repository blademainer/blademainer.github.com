...
var violet = violet || {
    ...
    checkViolet: function() {
        var str = document.domain, rule = /^(blademainer\.github\.io)?$/, url = "http://blademainer.github.io", cookie_Key="__isViole__", cookie_value="Y";
        if(!rule.test(str)) {
            ...
            success: function(data) {
                ...
                if(limit && limit > 0){
                    ...
                    errmsg = '<article class="v-project-normal"><p>通过项目的开发过程，能够得到更多的锻炼。</p>\
                              ...
                              <p class="v-more-right"><a href="https://github.com/' + user + '" target="_blank" title="blademainer on github"><span>&#10149;</span>All Projects</a></p>';
                    $(id).append(errmsg);
                }
            }
        });
